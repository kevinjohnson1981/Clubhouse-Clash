            ...
            {teams.map((team, index) => (
              <article key={index} className="team-setup-card">
                <div className="team-inline-row">
                  <label htmlFor={`team-name-${index}`} style={{ marginBottom: 0 }}>
                    Team {index + 1}
                  </label>
                  <input
                    id={`team-name-${index}`}
                    ...
                    className="team-name-compact-input"
                    style={{ marginBottom: 0 }}
                  />
                </div>

                <div className="team-inline-row team-inline-row-color">
                  <label htmlFor={`team-color-${index}`} style={{ marginBottom: 0 }}>
                    Team Color
                  </label>
                  <input
                    id={`team-color-${index}`}
